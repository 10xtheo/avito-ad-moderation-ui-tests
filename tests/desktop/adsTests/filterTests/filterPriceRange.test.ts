...
test.describe("Негативные проверки фильтрации по диапазону цен", () => {
    ...
    test("Нулевая нижняя граница (От)", async ({ page }) => {
        ...
        //assert
        await mainPage.waitForOpen();
        await mainPage.assertZeroCardsBelongToPriceRange(PRICE_ZERO, null);
    });
    ...
    // TODO: добавить сортировки разные в по цене в начале тестов, 
    // TODO: добавить граничные падающие кейсы на "проблему 5000"
    // TODO: как-то ещё раскрыть "проблему 5000", наглядно
    // TODO: добавить в асерты проверку последней страницы в пагинации
});
